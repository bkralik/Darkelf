...
this.Heroes = new function() {
	...
	this.mage =              new HS(310,3,   250,3  , 520,4,   160,2,   170,2,   170,2,   130,2.4, 130,2.3, 1150,5);
	...
	this.thief =             new HS(430,3.1, 300,3.1, 540,4,   170,2.2, 120,1.5, 120,1.6,  80,1.9, 130,2.2, 1100,5);
	this.novice_hero =       new HS(500,4,   400,4,   600,5,   220,3,   220,3,   220,3,   200,3,   200,3,   1300,6);
    this.extra_hero =        new HS(270,2.7, 200,2.6, 580,4.1, 200,2.7, 200,2.4, 140,2.5, 170,2.8, 120,1.7, 1200,5.3);
};
